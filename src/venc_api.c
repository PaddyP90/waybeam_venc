...
static const FieldDesc g_fields[] = {
	...
	FIELD(video0, slices_enabled,  FT_BOOL,   MUT_RESTART),
	FIELD(video0, slice_size,      FT_UINT,   MUT_RESTART),
	...
	FIELD(outgoing, target_pkt_rate,   FT_UINT16, MUT_RESTART),
	FIELD(outgoing, send_feedback,     FT_BOOL,   MUT_RESTART),
...
static const FieldAlias g_field_aliases[] = {
	...
	{ "video0.sliceSize", "video0.slice_size" },
	{ "outgoing.maxPayloadSize", "outgoing.max_payload_size" },
	{ "outgoing.targetPacketRate", "outgoing.target_pkt_rate" },
